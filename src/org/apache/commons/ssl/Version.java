/*
 * $HeadURL: http://juliusdavies.ca/svn/not-yet-commons-ssl/tags/commons-ssl-0.3.11/src/java/org/apache/commons/ssl/Version.java $
 * $Revision: 130 $
...
/**
 * Extracts tagged version from a subversion $HeadURL: http://juliusdavies.ca/svn/not-yet-commons-ssl/tags/commons-ssl-0.3.11/src/java/org/apache/commons/ssl/Version.java $ property, and prints it
...
public class Version {
    public static final String HEAD_URL = "$HeadURL: http://juliusdavies.ca/svn/not-yet-commons-ssl/tags/commons-ssl-0.3.11/src/java/org/apache/commons/ssl/Version.java $";
    ...
    private static class CompileTime {
        ...
        public static String getCompileTimeString(@SuppressWarnings("rawtypes") Class clazz) {
